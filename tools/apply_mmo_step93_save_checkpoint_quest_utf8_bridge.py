#!/usr/bin/env python3
"""Install Step93 quest UTF-8/idempotency bridge."""
...
SQL_PATH = ROOT / "server" / "sql" / "step93_save_checkpoint_quest_utf8_bridge.sql"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Install Step93 quest UTF-8/idempotency bridge.")
    ...
    result: dict[str, object] = {
        "step": "93_save_checkpoint_quest_utf8_bridge",
