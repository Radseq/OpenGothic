...
SQL_PATH = ROOT / "server" / "sql" / "step60_clean_db_equipment_bridge.sql"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Install Step60 clean-DB equipment bridge procedures.")
