#!/usr/bin/env python3
"""Install Step83 clean-DB combat/lifecycle bridge procedures."""
...
SQL_PATH = ROOT / "server" / "sql" / "step83_combat_lifecycle_bridge.sql"
REQUIRED_ROUTINES = (
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Install Step83 combat/lifecycle bridge procedures.")
    ...
    result: dict[str, object] = {
        "step": "83_combat_lifecycle_bridge",
