#!/usr/bin/env python3
"""Install Step68 drop/loot inventory bridge procedures."""
...
SQL_PATH = ROOT / "server" / "sql" / "step68_drop_loot_inventory_bridge.sql"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Install Step68 drop/loot inventory bridge procedures.")
