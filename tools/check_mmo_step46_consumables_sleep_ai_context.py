#!/usr/bin/env python3
"""Check Step46 consumable item, sleep/world-clock, weapon spam and world-AI coverage.

This checker extends Step45 with consumed item/resource delta and sleep/world-clock coverage while keeping weapon, corpse loot and NPC-vs-NPC combat/death coverage. It
...
def main(argv: list[str]) -> int:
    ...
    print(f"OK: Step46 domains={ {k:v['total'] for k,v in domains.items() if v['present']} }")
    if world_ai:
